...
export function CardFront({ icon, title, description }: CardFrontProps) {
  return (
    <div className="absolute inset-0 flex flex-col px-16 py-[62px] gap-[30px] border-[3px] rounded-[10px] shadow-[0px_6.59px_0px_#000000] bg-[color:var(--white)] [backface-visibility:hidden] cursor-pointer">
